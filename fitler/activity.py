...
class Activity(Model):
    ...
    def to_json(self) -> str:
        ...
        fields = [
            'start_time', 'date', 'distance', 'name', 'notes', 'equipment', 'activity_type', 
            'temperature', 'location_name', 'city', 'state', 'duration_hms', 'max_speed',
            'avg_heart_rate', 'max_heart_rate', 'calories', 'max_elevation', 'total_elevation_gain',
            'avg_cadence', 'spreadsheet_id', 'strava_id', 'garmin_id', 'ridewithgps_id',
            'strava_data', 'ridewithgps_data', 'garmin_data', 'spreadsheet_data',
            'last_updated', 'original_filename', 'source'
        ]
